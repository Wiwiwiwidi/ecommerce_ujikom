                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="/kategori" class="nav-item nav-link">All Kategory</a>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-3">
                        <nav class="navbar bg-light">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="kategori"><i class="fa fa-microchip"></i>Electronics & Accessories</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
                    ...
                    <div class="header-slider-item text-center">
                        <img src="{{ asset('image/download (2).jpg') }}" width="400px" alt="Slider Image" />
                        <div class="header-slider-caption">
                            <p>Product Owesome</p>
                        </div>
                    </div>
                    <div class="header-slider-item text-center">
                        <img src="{{ asset('image/4b66f2110b4576c576f7bb1b83998a7b.jpg-1702210203.jpg') }}" width="400px" alt="Slider Image" />
                        <div class="header-slider-caption">
                            <p>Bahan Alami Ramah Bumi</p>
                        </div>
                    </div>
                    <div class="header-slider-item text-center">
                        <img src="{{ asset('image/0b9ec8ab1e0d44466b5500e8b53c9890.jpg') }}" width="400px" alt="Slider Image" />
                        <div class="header-slider-caption">
                            <p>Premium Harga Terjangkau</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-3">
                        <div class="header-img">
                            <div class="img-item">
                                <img src="{{asset('image/download (3).jpg')}}" />
                                <a class="img-text" href="">
                                    <p>Some text goes here that describes the image</p>
                                </a>
                            </div>
                            <div class="img-item">
                                <img src="{{asset('image/download (1).jpg')}}" />
                                <a class="img-text" href="">
                                    <p>Some text goes here that describes the image</p>
                                </a>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 copyright">
                        <p>Copyright &copy; <a href="#">pangesti widi</a>. All Rights Reserved</p>
                    </div>
                </div>
            </div>
        </div>
